...
#include "tim.h"
/*Some Static Colors------------------------------*/ 
//const RGB_Color_TypeDef RED      = {0x20,0,0};   //显示红色RGB数据
//const RGB_Color_TypeDef ORANGE   = {106,80,0};
//const RGB_Color_TypeDef YELLOW   = {106,0x20,0};
//const RGB_Color_TypeDef GREEN    = {0,0x22,0};
//const RGB_Color_TypeDef CYAN	 = {0,0x22,0x22};
//const RGB_Color_TypeDef BLUE     = {0,0,0x22};
//const RGB_Color_TypeDef PURPLE	 = {0x20,106,0x20};
//const RGB_Color_TypeDef BLACK    = {0,0,0};
//const RGB_Color_TypeDef WHITE    = {64,64,64};
...
const RGB_Color_TypeDef BLACK    = {0,0,0};
const RGB_Color_TypeDef WHITE    = {90,90,90};
const RGB_Color_TypeDef MAGENTA  = {255,0,220};

RGB_Color_TypeDef RGB_Color;
...
{
	int i;
	for(i = 1; i <= Pixel_NUM ;i++) {	//红
		rgb_show(i, RED);		
	}
	for(i = 1; i <= Pixel_NUM ;i++) {	//橙
		rgb_show(i, ORANGE);		
	}
	for(i = 1; i <= Pixel_NUM ;i++) {	//黄
		rgb_show(i, YELLOW);		
	}
	for(i = 1; i <= Pixel_NUM ;i++) {	//绿
		rgb_show(i, GREEN);		
	}
	for(i = 1; i <= Pixel_NUM ;i++) {	//青
		rgb_show(i, CYAN);		
	}
	for(i = 1; i <= Pixel_NUM ;i++) {	//蓝
		rgb_show(i, BLUE);		
	}
	for(i = 1; i <= Pixel_NUM ;i++) {	//紫
		rgb_show(i, PURPLE);		
	}
