...
{//路劲规划任务
	...
	#if 1
		Debug_Await();// 等待按键被按下
//		Run_1();My_mDelay(1000);
//		Debug_Await();
//		Run_2();My_mDelay(1000);
//		Debug_Await();
//		Run_3();My_mDelay(1000);
//		Debug_Await();
//		Run_4();My_mDelay(1000);
//		Debug_Await();
//		Run_M();My_mDelay(1000);
		
		// 1. 底盘控制
		// 先从起点到道路中心
		ChassisCoord_Set(-150,-150, 0); ChassisCoord_WaitStop();  
		// 去到十字路口，准备去到粗加工区
		ChassisCoord_Set(-1050,-150,   0); ChassisCoord_WaitStop(); 
		ChassisCoord_Set(-1050,-150, 180); ChassisCoord_WaitStop(); 
		// 到粗加工区,机械臂需要夹取
		ChassisCoord_Set(-1100,-1900, 0); ChassisCoord_WaitStop(); 
	
		// 2. 机械臂开始干活
		Run_Right() ;My_mDelay(1000);
		Run_Middle() ;My_mDelay(1000);
		Run_Left() ;My_mDelay(1000);
		...
		// 4. 放物料
		Back_Left() ;My_mDelay(1000);
		Back_Middle() ;My_mDelay(1000);
		Back_Right() ;My_mDelay(1000);
